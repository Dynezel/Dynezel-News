...
export default function Publicidades() {
  ...
  // Función para crear y agregar scripts de manera segura
  ...
  const addAdBlock = () => {
    ...
    switch (adType) {
      ...
      case 2: // Native Banner
        ...
        containerNative.id = "container-feb5072d03cb15bc5abe1c885dd6e313";
  ...
  // Bloques iniciales
  useEffect(() => {
    const initialBlocks = Math.floor(Math.random() * 3) + 5; // 5-7 bloques
